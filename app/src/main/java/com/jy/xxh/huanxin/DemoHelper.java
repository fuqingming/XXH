...
import com.jy.xxh.ChatActivityc;
...
//        options.setImPort(31097);
    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.getNotifier().setNotificationInfoProvider(new EaseNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                Intent intent = new Intent(appContext, ChatActivityc.class);
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onFriendRequestAccepted(String username) {
            ...
            msg.setStatus(com.jy.xxh.huanxin.domain.InviteMessage.InviteMessageStatus.BEAGREED);
            notifyNewInviteMessage(msg);
            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_CONTACT_CHANAGED));
        }
                    ...
                    if(!easeUI.hasForegroundActivies()){
                        ...
                        if(msgType == EMMessage.Type.TXT){
                            ...
                            if(strReplay != null && !"".equals(strReplay)){
                                try {
                                    JSONObject jsonObject = new JSONObject(strReplay);
                                    String strStuName = jsonObject.getString("stu_name");
                                    String strStuQuestion = jsonObject.getString("stu_question");
                                    it.putExtra("strStuName", strStuName);
                                    it.putExtra("strStuQuestion", strStuQuestion);
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                            }else{
                                it.putExtra("strStuName", "");
                        ...
                        it.putExtra("iMsgType", iMsgType);
                        it.putExtra("strFromId",message.getFrom() );
                        it.putExtra("nickname",message.getStringAttribute("nickname",null));
                        it.putExtra("headerImageUrl",message.getStringAttribute("headerImageUrl",null));
