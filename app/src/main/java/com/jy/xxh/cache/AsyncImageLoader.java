...
public class AsyncImageLoader{
	...
	public static AsyncImageLoader getInstace(Context context){
		if(mImageLoader == null){
			ImageCacheManager cacheMgr = new ImageCacheManager(context);
			mImageLoader = new AsyncImageLoader(context, cacheMgr.getMemoryCache(), cacheMgr.getPlacardFileCache());
		}
		return mImageLoader;
	}
