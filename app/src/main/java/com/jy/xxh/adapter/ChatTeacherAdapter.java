...
public class ChatTeacherAdapter extends CommonRecyclerAdapter<ChatMessageBean> {
    private KJBitmap kjb;
    private Context mContext;
    private ChatActivity.OnChatItemClickListener listener;

    public ChatTeacherAdapter(@NonNull Context context, ChatActivity.OnChatItemClickListener listener) {
        super(context, 0);
