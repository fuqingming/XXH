...
public class ChatAdapter extends CommonRecyclerAdapter<ChatMessageBean> {
    private KJBitmap kjb;
    private Context mContext;
    private ChatActivityc.OnChatItemClickListener listener;

    public ChatAdapter(@NonNull Context context, ChatActivityc.OnChatItemClickListener listener) {
        super(context, 0);
